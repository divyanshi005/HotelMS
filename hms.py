...
def MYSQLconnectionCheck():
    ...
    myConnection=mysql.connector.connect(host="localhost",user="root",password="dh121234" ,auth_plugin='mysql_native_password' )
    if myConnection:
...
def MYSQLconnection():
 ...
 global myConnection
 global cid
 myConnection=mysql.connector.connect(host="localhost",user="root",password="dh121234" ,database="HMS" , auth_plugin='mysql_native_password' )
 if myConnection:
     return myConnection
 else:
